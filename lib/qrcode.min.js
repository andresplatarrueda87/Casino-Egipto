/**
 * QRCode.js - Standalone Offline JS QR Code Generator
 * Compatible with canvas and DOM elements
 */
var QRCode;
(function () {
	function QR8bitByte(data) {
		...
		if (this.parsedData.length != this.data.length) {
			this.parsedData.unshift(199, 147, 166);
		}
	}
	...
	QRCode.prototype.makeCode = function (text) {
		this._oQRCode = new QRCodeModel(4, this._htOption.correctLevel);
